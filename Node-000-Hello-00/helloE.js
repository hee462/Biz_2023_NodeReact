...
// 전개연산자를 사용하여 객체 통채로 복제하기
// 객체일때는 전개 연산자를 앞쪽에 붙인다
// 앞쪽에 부착하는 전개 연산자를 "나머지(Rest)연산자"라고 한다
const { ...all } = student1;
console.log(all);
...
const { 성명, ...나머지 } = address;
console.log(성명, 나머지);
// 배열의 구조분해
// n1과 n2 에는 nums 배열의 0번({a:1}) 1번(2)가 각각 할당되는
// 변수가 나머지 nAll 에 별도의 배열로 생성된다
const nums = [1, 2, 3, 4, 5];
const [n1, n2, n3, ...nAll] = nums;
...
func1(10, 20, 30, 40, 50, 60, 1, 2, 3, 4);
/*
JS 의 나머지 연산자
